...
<template>
    <form>
        ...
        <div class="border-b border-cyan-800/10 pb-12">
          ...
          <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="sm:col-span-3">
              ...
              <div class="mt-2">
                <input id="iban" name="iban" type="iban" autocomplete="iban" v-model="applicantData.bankAccount.iban" class="block w-full rounded-md border-0 py-1.5 px-2 text-cyan-800 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-cyan-600 sm:text-sm sm:leading-6" />
              </div>
            </div>
        ...
        <div class="border-b border-cyan-800/10 pb-12">
          ...
          <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="sm:col-span-3">
              <label for="first-name" class="block text-sm font-medium leading-6 text-cyan-800">Eesnimi</label>
              <div class="mt-2">
                <input type="text" name="first-name" id="first-name" autocomplete="first-name" v-model="applicantData.emergencyContact.firstName" class="block w-full rounded-md border-0 py-1.5 px-2 text-cyan-800 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-cyan-600 sm:text-sm sm:leading-6" />
              </div>
            </div>
            ...
            <div class="sm:col-span-3">
              <label for="last-name" class="block text-sm font-medium leading-6 text-cyan-800">Perekonnanimi</label>
              <div class="mt-2">
                <input type="text" name="last-name" id="last-name" autocomplete="last-name" v-model="applicantData.emergencyContact.lastName" class="block w-full rounded-md border-0 py-1.5 px-2 text-cyan-800 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-cyan-600 sm:text-sm sm:leading-6" />
              </div>
            </div>
            ...
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    <select id="relationship-type" name="relationship-type" v-model="applicantData.emergencyContact.relationshipType" class="block w-full rounded-md border-0 py-2 px-1 text-cyan-800 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-cyan-600 sm:max-w-xs sm:text-sm sm:leading-6">
      ...
      <div class="mt-6 flex items-center justify-end gap-x-6">
        <button type="button" class="text-sm font-semibold leading-6 text-cyan-800">Cancel</button>
        <button type="submit" class="rounded-md bg-teal-700 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-teal-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600">Save</button>
      </div>
    </form>
  </template>
